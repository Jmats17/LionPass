...
extension UIColor {
    ...
    public struct GradientProgressBar {
        ...
        static let backgroundColorForLightMode = UIColor(red: 165/255, green: 179/255, blue: 203/255, alpha: 1.0)

        /// Default background color for the progress view in dark mode.
        static let backgroundColorForDarkMode = UIColor(red: 165/255, green: 179/255, blue: 203/255, alpha: 1.0)
